      ...
      child: ScaffoldMessenger(
        child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton.extended(
              ...
              icon:
                  const Icon(FontAwesome5.arrow_circle_up, color: Colors.white),
              ...
              slivers: <Widget>[
                SliverAppBar(
                  ...
                  actions: [
                    IconButton(
                      icon: Text(
                        context.locale.languageCode == 'en' ? "MY" : "EN",
                        style: TextStyle(
                          color:
                              _isLightTheme.value ? Colors.black : Colors.white,
                        ),
                      ),
                      onPressed: () {
